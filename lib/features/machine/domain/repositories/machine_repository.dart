...
abstract class MachineRepository {
  ...
  ///
  /// Retorna [List<RegistroMaquina>] em caso de sucesso ou [Failure] em caso de erro
  // TODO: Implementar método para buscar todas as máquinas
  // Future<Either<Failure, List<RegistroMaquina>>> getAllMachines();
  ...
  Future<Either<Failure, MachineConfig>> saveMachineConfig(
  ...
  Future<Either<Failure, MachineConfig?>> getCurrentMachineConfig(
    String deviceId,
    String userId,
  );
  ...
  /// [userId] - ID do usuário
  /// Retorna [void] em caso de sucesso ou [Failure] em caso de erro
  Future<Either<Failure, void>> removeMachineConfig(
    String deviceId,
    String userId,
  );
  ...
  /// [deviceId] - ID do dispositivo
  /// Retorna [void] em caso de sucesso ou [Failure] em caso de erro
  Future<Either<Failure, void>> removeAllActiveConfigsForDevice(
    String deviceId,
  );
}